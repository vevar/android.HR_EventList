...
import com.alxminyaev.eventlist.feature.feature.eventtable.presentation.part.EventCardView
...
class EventTableAdapter(context: Context) : RecyclerView.Adapter<EventTableAdapter.EventHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): EventHolder {
        val view = inflater.inflate(R.layout.event_card, parent, false) as EventCardView
